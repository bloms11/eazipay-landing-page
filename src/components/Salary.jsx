...
const Salary = () => {
  return (
    <div className="bg-[#FFE9E7] overflow-hidden relative mt-12 h-max">
      <img className="absolute top-0 left-40" src={Dots} />
      <div className="overlay-2 flex justify-center items-center">
        <div className="flex mx-auto w-max my-[7%]">
